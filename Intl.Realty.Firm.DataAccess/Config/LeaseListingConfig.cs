...
{
    public class LeaseListingConfig : IEntityTypeConfiguration<LeaseListing>
    {
        public void Configure(EntityTypeBuilder<LeaseListing> builder)
        {
            builder.ToTable("LeaseListings");
