...
{
    public static class SaleCoopMapper
    {
        public static SaleCoopViewModel ToSaleCoopViewModel(this SaleCoop model)
        {
            return new SaleCoopViewModel
            {
                Id = model.Id,
        ...
        public static SaleCoop ToSaleCoopModel(this CreateSaleCoopViewModel viewModel)
        {
            return new SaleCoop
            {
        ...
        public static CreateSaleCoopViewModel ToCreateSaleCoopViewModel(this SaleCoop model)
        {
            return new CreateSaleCoopViewModel
            {
                TransactionTypeId = model.TransactionTypeId,
                IRFDealId = model.IRFDealId,
                DealStatusId= model.DealStatusId,
        ...
        public static EditSaleCoopViewModel ToEditSaleCoopViewModel(this SaleCoop model)
        {
            return new EditSaleCoopViewModel
            {
                Id = model.Id,
                TransactionTypeId = model.TransactionTypeId,
        ...
        public static List<SaleCoopViewModel> ToSaleCoopListViewModel(this List<SaleCoop> modelList)
        {
            var viewModelList = new List<SaleCoopViewModel>();
            if (modelList != null)
            {
                viewModelList = modelList.Select(x => new SaleCoopViewModel()
                {
                    Id = x.Id,
        ...
        public static List<SaleCoopViewModel> ToSaleCoopListViewModel(this IEnumerable<SaleCoop> modelList)
        {
            var viewModelList = new List<SaleCoopViewModel>();
            if (modelList != null)
            {
        ...
        public static List<SaleCoopExport> ToSaleCoopListExport(this List<SaleCoop> modelList)
        {
            List<SaleCoopExport> exportList = new List<SaleCoopExport>();

            if (modelList != null)
            {
                exportList = modelList.Select(x => new SaleCoopExport
                {
